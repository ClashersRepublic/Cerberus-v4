namespace RivieraStudio.Magic.Dos.Bot
{
    using System;
    using RivieraStudio.Magic.Dos.Debug;
    using RivieraStudio.Magic.Dos.Network;
    using RivieraStudio.Magic.Logic;
    using RivieraStudio.Magic.Logic.Message;
    using RivieraStudio.Magic.Logic.Message.Account;
    using RivieraStudio.Magic.Logic.Message.Security;
    using RivieraStudio.Magic.Titan;
