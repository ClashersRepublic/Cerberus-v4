...
namespace RivieraStudio.Magic.Services.Core.Libs.Lzma.Compression.LZMA
{
    using System;
    using System.IO;
    using RivieraStudio.Magic.Services.Core.Libs.Lzma.Compression.LZ;
    using RivieraStudio.Magic.Services.Core.Libs.Lzma.Compression.RangeCoder;
