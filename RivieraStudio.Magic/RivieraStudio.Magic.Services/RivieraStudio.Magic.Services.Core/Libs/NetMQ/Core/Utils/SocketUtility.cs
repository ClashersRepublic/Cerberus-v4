namespace RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Utils
{
    ...
    internal static class SocketUtility
    {
        ...
        ///     Select returns when at least one of the sockets of interest (ie any of the sockets in the checkRead, checkWrite, or
        ///     checkError
        ...
        ///     If you have made a non-blocking call to Connect, the checkError parameter identifies sockets that have not
