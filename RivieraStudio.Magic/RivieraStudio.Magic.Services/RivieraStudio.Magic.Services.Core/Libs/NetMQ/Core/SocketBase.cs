...
namespace RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core
{
    ...
    using AsyncIO;
    using RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Patterns;
    using RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Transports.Ipc;
    using RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Transports.Pgm;
    using RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Transports.Tcp;
    using RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Utils;
    using JetBrains.Annotations;
    using TcpListener = RivieraStudio.Magic.Services.Core.Libs.NetMQ.Core.Transports.Tcp.TcpListener;
