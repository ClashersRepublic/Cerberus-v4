namespace RivieraStudio.Magic.Services.Core.Libs.NetMQ
{
    ...
    ///     which is derived from all of the Network Interfaces present on this host at the time an instance of this class is
    ///     created.
    /// </summary>
    public class InterfaceCollection : IEnumerable<InterfaceItem>
    {
        ...
        /// <summary>
        ///     Create a new InterfaceCollection that contains a list of InterfaceItems derived from all of the Network Interfaces
        ...
        public InterfaceCollection()
        {
            ...
            this.m_interfaceItems = new List<InterfaceItem>();
            ...
            foreach (UnicastIPAddressInformation address in addresses)
            {
                ...
                this.m_interfaceItems.Add(new InterfaceItem(address.Address, broadcastAddress));
            }
        }
        ...
        {
            return this.m_interfaceItems.GetEnumerator();
        }
