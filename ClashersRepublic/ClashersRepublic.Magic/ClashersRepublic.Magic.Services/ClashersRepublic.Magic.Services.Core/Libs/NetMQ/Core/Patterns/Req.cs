...
namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ.Core.Patterns
{
    ...
    internal sealed class Req : Dealer
    {
        ...
        {
            this.m_receivingReply = false;
            this.m_messageBegins = true;
            this.m_options.SocketType = ZmqSocketType.Req;
        }
