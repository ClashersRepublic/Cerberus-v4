...
namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ.Core.Patterns
{
    ...
    internal class Dealer : SocketBase
    {
            ...
            : base(parent, threadId, socketId)
        {
            ...
            this.m_options.SocketType = ZmqSocketType.Dealer;

            this.m_fairQueueing = new FairQueueing();
            this.m_loadBalancer = new LoadBalancer();
        ...
        protected override void XAttachPipe(Pipe pipe, bool icanhasall)
        {
            ...
            this.m_loadBalancer.Attach(pipe);
        }
        ...
        {
            return this.m_loadBalancer.Send(ref msg);
        }
        ...
        {
            return this.ReceiveInternal(ref msg);
        }
        ...
        protected override bool XHasIn()
        {
            ...
            bool isMessageAvailable = this.ReceiveInternal(ref this.m_prefetchedMsg);
        ...
        {
            return this.m_loadBalancer.HasOut();
        }
        ...
        {
            this.m_loadBalancer.Activated(pipe);
        }
        ...
        protected override void XTerminated(Pipe pipe)
        {
            ...
            this.m_loadBalancer.Terminated(pipe);
        }
    }
}