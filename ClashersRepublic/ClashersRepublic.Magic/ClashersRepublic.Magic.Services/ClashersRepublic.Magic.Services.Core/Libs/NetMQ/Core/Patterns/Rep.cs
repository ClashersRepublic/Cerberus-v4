...
namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ.Core.Patterns
{
    ...
    internal sealed class Rep : Router
    {
        ...
        {
            this.m_sendingReply = false;
            this.m_requestBegins = true;

            this.m_options.SocketType = ZmqSocketType.Rep;
        }
