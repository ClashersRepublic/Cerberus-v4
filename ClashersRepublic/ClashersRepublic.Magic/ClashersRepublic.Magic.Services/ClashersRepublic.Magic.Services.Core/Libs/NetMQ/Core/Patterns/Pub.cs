...
namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ.Core.Patterns
{
    ...
    internal sealed class Pub : XPub
    {
        ...
        {
            this.m_options.SocketType = ZmqSocketType.Pub;
        }

        /// <summary>
        ///     This override of the abstract XRecv method, simply throws a NotSupportedException because XRecv is not supported on
        ///     a Pub socket.
        /// </summary>
