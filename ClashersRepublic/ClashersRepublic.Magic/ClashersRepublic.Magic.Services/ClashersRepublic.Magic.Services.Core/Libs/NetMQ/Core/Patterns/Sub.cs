...
namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ.Core.Patterns
{
    ...
    internal sealed class Sub : XSub
    {
        ...
        ///     This override of that abstract method simply throws NotSupportedException because XSend is not supported on a Sub
        ///     socket.
        /// </summary>
