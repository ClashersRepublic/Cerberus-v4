namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ
{
    ...
    public static class OutgoingSocketExtensions
    {
        ...
        public static bool TrySendFrame([NotNull] this IOutgoingSocket socket, [NotNull] byte[] data,
            bool more = false)
        {
            return socket.TrySendFrame(TimeSpan.Zero, data, more);
        }
        ...
        {
            socket.SendMultipartBytes((IEnumerable<byte[]>) frames);
        }
        ...
        {
            return socket.TrySendMultipartBytes(TimeSpan.Zero, (IEnumerable<byte[]>) frames);
        }
        ...
        {
            return socket.TrySendFrame(timeout, EmptyArray<byte>.Instance, more);
        }
