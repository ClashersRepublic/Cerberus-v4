namespace ClashersRepublic.Magic.Services.Core.Libs.NetMQ
{
    ...
    public class BufferManagerBufferPool : IBufferPool
    {
        ...
        {
            this.m_bufferManager = BufferManager.CreateBufferManager(maxBufferPoolSize, maxBufferSize);
        }
        ...
        {
            return this.m_bufferManager.TakeBuffer(size);
        }
    ...
    public static class BufferPool
    {
        ...
        {
            BufferPool.SetCustomBufferPool(new GCBufferPool());
        }
        ...
        {
            BufferPool.SetCustomBufferPool(new BufferManagerBufferPool(maxBufferPoolSize, maxBufferSize));
        }
        ...
        {
            return BufferPool.s_bufferPool.Take(size);
        }
        ...
        {
            BufferPool.s_bufferPool.Return(buffer);
        }
    }
}