...
namespace ClashersRepublic.Magic.Services.Core.Libs.Lzma.Compression.LZMA
{
    using System;
    using System.IO;
    using ClashersRepublic.Magic.Services.Core.Libs.Lzma.Compression.LZ;
    using ClashersRepublic.Magic.Services.Core.Libs.Lzma.Compression.RangeCoder;
