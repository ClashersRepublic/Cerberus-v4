namespace LineageSoft.Magic.Logic.Level
{
    ...
    using LineageSoft.Magic.Logic.Offer;
    using LineageSoft.Magic.Logic.Time;
    using LineageSoft.Magic.Logic.Util;
    using LineageSoft.Magic.Logic.Worker;
