namespace LineageSoft.Magic.Services.Core.Message
{
    using LineageSoft.Magic.Services.Core.Message.Account;
    using LineageSoft.Magic.Services.Core.Message.Admin;
    using LineageSoft.Magic.Services.Core.Message.Avatar;
    using LineageSoft.Magic.Services.Core.Message.Avatar.Stream;
