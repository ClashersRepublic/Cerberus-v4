namespace LineageSoft.Magic.Services.Core.Libs.NetMQ
{
    ...
    public enum ErrorCode
    {
        ...
        /// </summary>
        MessageSize = ErrorCode.BaseErrorNumber + 10,

        /// <summary>
        ///     The address family is not supported by this protocol.
        /// </summary>
        AddressFamilyNotSupported = ErrorCode.BaseErrorNumber + 11,

        /// <summary>
        ///     The network is apparently not reachable.
        /// </summary>
        NetworkUnreachable = ErrorCode.BaseErrorNumber + 12,

        /// <summary>
        ///     The connection-attempt has apparently been aborted.
        /// </summary>
        ConnectionAborted = ErrorCode.BaseErrorNumber + 13,

        /// <summary>
        ///     The connection has apparently been reset.
        /// </summary>
        ConnectionReset = ErrorCode.BaseErrorNumber + 14,

        /// <summary>
        ///     The operation timed-out.
        /// </summary>
        TimedOut = ErrorCode.BaseErrorNumber + 16,

        /// <summary>
        ///     The connection has apparently been reset.
        /// </summary>
        NetworkReset = ErrorCode.BaseErrorNumber + 18,

        /// <summary>
        ///     The operation cannot be performed on this socket at the moment due
        ///     to the socket not being in the appropriate state.
        /// </summary>
        FiniteStateMachine = ErrorCode.BaseErrorNumber + 51,

        /// <summary>
        ///     The context associated with the specified socket has already been terminated.
        /// </summary>
        ContextTerminated = ErrorCode.BaseErrorNumber + 53,

        /// <summary>
        ///     No I/O thread is available to accomplish this task.
        /// </summary>
        EmptyThread = ErrorCode.BaseErrorNumber + 54,

        /// <summary>
        ///     Too many sockets for this process.
        /// </summary>
        TooManyOpenSockets = ErrorCode.BaseErrorNumber + 107
    }
}