namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Sockets
{
    using System.Text;
    ...
    public class XPublisherSocket : NetMQSocket
    {
        ...
        ///     List of NetMQ endpoints, separated by commas and prefixed by '@' (to bind the socket) or '>' (to connect the
        ///     socket).
        ///     Default action is bind (if endpoint doesn't start with '@' or '>')
        /// </param>
        /// <example>
        ///     <code>var socket = new XPublisherSocket(">tcp://127.0.0.1:5555,>127.0.0.1:55556");</code>
        /// </example>
        ...
        {
            this.SetSocketOption(ZmqSocketOption.Subscribe, topic);
        }
        ...
        {
            this.Subscribe(encoding.GetBytes(topic));
        }
        ...
        {
            this.SetSocketOption(ZmqSocketOption.Unsubscribe, topic);
        }
        ...
        {
            this.Unsubscribe(encoding.GetBytes(topic));
        }
        ...
        /// <summary>
        ///     Publisher sockets generally send a welcome-message to subscribers to give an indication that they have successful
        ///     subscribed.
        ///     This method clears that message, such that none is sent.
        /// </summary>
        public void ClearWelcomeMessage()
        {
            this.SetSocketOption(ZmqSocketOption.XPublisherWelcomeMessage, null);
        }
        ...
        {
            this.SetWelcomeMessage(encoding.GetBytes(welcomeMessage));
        }
        ...
        {
            this.SetWelcomeMessage(Encoding.ASCII.GetBytes(welcomeMessage));
        }
        ...
        {
            this.SetSocketOption(ZmqSocketOption.XPublisherWelcomeMessage, welcomeMessage);
        }
    }
}