namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Sockets
{
    ...
    public class PairSocket : NetMQSocket
    {
        ...
        /// </param>
        /// <example>
        ///     <code>var socket = new PairSocket(">tcp://127.0.0.1:5555,@127.0.0.1:55556");</code>
        /// </example>
        ...
        {
            string address = $"inproc://NetMQSocketPair#{Interlocked.Increment(ref PairSocket.s_sequence)}";
