namespace LineageSoft.Magic.Services.Core.Libs.NetMQ
{
    ...
    public class NetMQTimer
    {
        ...
        public NetMQTimer(int interval)
        {
            ...
            this.m_timerEventArgs = new NetMQTimerEventArgs(this);
            this.m_enable = true;
            this.When = -1;
        }
        ...
        /// </summary>
        /// <remarks>
        ///     When setting this, When is set to the future point in time from now at which the interval will expire (or -1 if not
        ///     Enabled).
        /// </remarks>
        public int Interval
        {
            ...
            set
            {
                ...
                this.When = this.Enable ? Clock.NowMs() + this.Interval : -1;
            }
        }
        ...
        public bool Enable
        {
            ...
            set
            {
                ...
                this.m_enable = value;
                this.When = this.m_enable ? Clock.NowMs() + this.Interval : -1;
            }
        }

        /// <summary>
        ///     Get or set the value of the low-precision timestamp (a value in milliseconds) that signals when the timer is to
        ///     expire,
        ...
        public void EnableAndReset()
        {
            ...
            {
                this.When = Clock.NowMs() + this.Interval;
            }
        }
        ...
        {
            this.Elapsed?.Invoke(sender, this.m_timerEventArgs);
        }
    }
}