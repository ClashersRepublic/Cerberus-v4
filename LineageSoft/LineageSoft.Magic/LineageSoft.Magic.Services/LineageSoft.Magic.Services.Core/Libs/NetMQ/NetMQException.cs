...
namespace LineageSoft.Magic.Services.Core.Libs.NetMQ
{
    ...
    /// <summary>
    ///     EndpointNotFoundException is a NetMQException that is used within Ctx.FindEndpoint to signal a failure to find a
    ///     specified address.
    /// </summary>
    #if !NETSTANDARD1_3
    [Serializable]
    ...
    /// <summary>
    ///     InvalidException is a NetMQException that is used within the message-queueing system to signal invalid value
    ///     errors.
    /// </summary>
    #if !NETSTANDARD1_3
    [Serializable]
    ...
    /// <summary>
    ///     FaultException is a NetMQException that is used within the message-queueing system to signal general fault
    ///     conditions.
    /// </summary>
    #if !NETSTANDARD1_3
    [Serializable]
