namespace LineageSoft.Magic.Services.Core.Libs.NetMQ
{
    ...
    public class NetMQMessage : IEnumerable<NetMQFrame>
    {
        ...
        {
            this.m_frames = new List<NetMQFrame>(expectedFrameCount);
        }
        ...
        public NetMQMessage([NotNull] IEnumerable<NetMQFrame> frames)
        {
            ...
            this.m_frames = new List<NetMQFrame>(frames);
        }
        ...
        public NetMQMessage([NotNull] IEnumerable<byte[]> buffers)
        {
            ...
            this.m_frames = buffers.Select(buf => new NetMQFrame(buf)).ToList();
        }
        ...
        public NetMQFrame Last
        {
            get
            {
                return this.m_frames[this.m_frames.Count - 1];
            }
        }
        ...
        /// <summary>
        ///     Add the given data (in this case a byte-array) to this NetMQMessage, at the highest-indexed position of the
        ///     frame-stack.
        ///     Data is not copied.
        /// </summary>
        ...
        {
            this.m_frames.Add(new NetMQFrame(buffer));
        }
        ...
        {
            this.m_frames.Add(new NetMQFrame(message));
        }
        ...
        {
            this.m_frames.Add(new NetMQFrame(message, encoding));
        }
        ...
        {
            this.m_frames.Add(NetMQFrame.Empty);
        }
        ...
        /// <remarks>
        ///     The concept is the same as pushing an element onto a stack.
        ///     This creates a new frame from the given data (in this case a byte-array) and inserts it into the lowest-indexed
        ///     position of
        ...
        {
            this.m_frames.Insert(0, new NetMQFrame(buffer));
        }

        /// <summary>
        ///     Push a new frame containing the given string (converted into a byte-array) into the frame-stack of this
        ///     NetMQMessage.
        /// </summary>
        /// <param name="message">the string to create a new frame from</param>
        /// <remarks>
        ///     The concept is the same as pushing an element onto a stack.
        ///     This creates a new frame from the given data (in this case a string which gets converted into a byte-array using
        ///     the default ASCII encoding) and inserts it into the lowest-indexed position of
        ///     the collection of frames of this NetMQMessage,
        ///     pushing all of the other frames upward in index-position.
        /// </remarks>
        public void Push([NotNull] string message)
        {
            this.m_frames.Insert(0, new NetMQFrame(message));
        }
        ...
        ///     The concept is the same as pushing an element onto a stack.
        ///     This creates a new frame from the given data (in this case a string which gets converted into a byte-array using
        ///     the given Encoding) and inserts it into the lowest-indexed position of
        ///     the collection of frames of this NetMQMessage,
        ///     pushing all of the other frames upward in index-position.
        /// </remarks>
        public void Push([NotNull] string message, [NotNull] Encoding encoding)
        {
            this.m_frames.Insert(0, new NetMQFrame(message, encoding));
        }

        /// <summary>
        ///     Push a new frame containing the given integer (converted into a byte-array) into the frame-stack of this
        ///     NetMQMessage.
        /// </summary>
        /// <param name="value">the integer to create a new frame from</param>
        /// <remarks>
        ///     The concept is the same as pushing an element onto a stack.
        ///     This creates a new frame from the given data (in this case a 32-bit integer which gets converted into a byte-array
        ///     in big-endian order) and inserts it into the lowest-indexed position of
        ///     the collection of frames of this NetMQMessage,
        ///     pushing all of the other frames upward in index-position.
        /// </remarks>
        ...
        {
            this.m_frames.Insert(0, NetMQFrame.Empty);
        }
        ...
        {
            NetMQFrame frame = this.m_frames[0];
        ...
        {
            return this.m_frames.Remove(frame);
        }
        ...
        public override string ToString()
        {
            ...
            bool first = true;
            foreach (NetMQFrame f in this.m_frames)
            {
                if (!first)
                {
                    sb.Append(",");
