namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Core
{
    ...
    internal enum ZmqSocketOption
    {
        ...
        /// <summary>
        ///     Setting this option subscribes a socket to messages that have the given topic. This is valid only for Subscriber
        ///     and XSubscriber sockets.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     The TCP keep-alive interval - the duration between two keepalive transmission if no response was received to a
        ///     previous keepalive probe.
        /// </summary>
        /// <remarks>
