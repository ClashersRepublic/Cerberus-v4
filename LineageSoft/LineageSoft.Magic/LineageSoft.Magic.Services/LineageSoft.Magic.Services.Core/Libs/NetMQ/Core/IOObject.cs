...
namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Core
{
    ...
    internal class IOObject : IProactorEvents
    {
        ...
        {
            this.m_ioThread.Proactor.AddSocket(socket, this);
        }
        ...
        {
            this.m_ioThread.Proactor.RemoveSocket(socket);
        }

        /// <summary>
        ///     This method is called when a message receive operation has been completed. This forwards it on to the handler's
        ///     InCompleted method.
        /// </summary>
        ...
        {
            this.m_handler.InCompleted(socketError, bytesTransferred);
        }

        /// <summary>
        ///     This method is called when a message Send operation has been completed. This forwards it on to the handler's
        ///     OutCompleted method.
        /// </summary>
        /// <param name="socketError">a SocketError value that indicates whether Success or an error occurred</param>
        /// <param name="bytesTransferred">the number of bytes that were transferred</param>
        ...
        {
            this.m_handler.OutCompleted(socketError, bytesTransferred);
        }
        ...
        {
            this.m_handler.TimerEvent(id);
        }

        public void AddTimer(long timeout, int id)
        {
            this.m_ioThread.Proactor.AddTimer(timeout, this, id);
        }
        ...
        {
            this.m_ioThread.Proactor.CancelTimer(this, id);
        }
    }
}