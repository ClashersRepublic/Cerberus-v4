...
namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Core.Transports.Ipc
{
    ...
    internal sealed class IpcListener : TcpListener
    {
        ...
        {
            this.m_address.Resolve(addr, false);

            base.SetAddress(this.m_address.Address.Address + ":" + this.m_address.Address.Port);
        }
    }
}