...
namespace LineageSoft.Magic.Services.Core.Libs.NetMQ.Core
{
    ...
    internal sealed class Address
    {
        ...
        {
            this.Protocol = Address.TcpProtocol;

            DnsEndPoint dnsEndPoint = endpoint as DnsEndPoint;
            if (dnsEndPoint != null)
            {
                this.AddressString = dnsEndPoint.Host + ":" + dnsEndPoint.Port;
                return;
            }
            ...
            if (ipEndPoint != null)
            {
                this.AddressString = ipEndPoint.Address + ":" + ipEndPoint.Port;
                return;
            }

            this.AddressString = endpoint.ToString();
        }
        ...
        public override string ToString()
        {
            if (this.Resolved != null)
            {
                ...
                {
                    case Address.TcpProtocol: return this.Resolved.ToString();
                    case Address.IpcProtocol: return this.Resolved.ToString();
                    case Address.PgmProtocol: return this.Resolved.ToString();
                }
            }

            if (!string.IsNullOrEmpty(this.Protocol) && !string.IsNullOrEmpty(this.AddressString))
            {
                return this.Protocol + "://" + this.AddressString;
            }
