...
{
    using System;
    using LineageSoft.Magic.Services.Core.Libs.NetMQ.Core;
    ...
    public class SocketOptions
    {
        ...
        public long Affinity
        {
            get
            {
                return this.m_socket.GetSocketOptionLong(ZmqSocketOption.Affinity);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.Affinity, value);
            }
        }
        ...
        public byte[] Identity
        {
            ...
            get
            {
                return this.m_socket.GetSocketOptionX<byte[]>(ZmqSocketOption.Identity);
            }
            [NotNull]
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.Identity, value);
            }
        }
        ...
        public int MulticastRate
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.Rate);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.Rate, value);
            }
        }
        ...
        public TimeSpan MulticastRecoveryInterval
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.RecoveryIvl);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.RecoveryIvl, value);
            }
        }
        ...
        public int SendBuffer
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.SendBuffer);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.SendBuffer, value);
            }
        }
        ...
        public int ReceiveBuffer
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.ReceiveBuffer);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.ReceiveBuffer, value);
            }
        }
        ...
        public bool ReceiveMore
        {
            get
            {
                return this.m_socket.GetSocketOptionX<bool>(ZmqSocketOption.ReceiveMore);
            }
        }
        ...
        public TimeSpan Linger
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.Linger);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.Linger, value);
            }
        }
        ...
        public TimeSpan ReconnectInterval
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.ReconnectIvl);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.ReconnectIvl, value);
            }
        }
        ...
        public TimeSpan ReconnectIntervalMax
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.ReconnectIvlMax);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.ReconnectIvlMax, value);
            }
        }
        ...
        public int Backlog
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.Backlog);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.Backlog, value);
            }
        }
        ...
        public long MaxMsgSize
        {
            get
            {
                return this.m_socket.GetSocketOptionLong(ZmqSocketOption.MaxMessageSize);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.MaxMessageSize, value);
            }
        }
        ...
        public int SendHighWatermark
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.SendHighWatermark);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.SendHighWatermark, value);
            }
        }
        ...
        public int ReceiveHighWatermark
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.ReceiveHighWatermark);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.ReceiveHighWatermark, value);
            }
        }
        ...
        public int SendLowWatermark
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.SendLowWatermark);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.SendLowWatermark, value);
            }
        }
        ...
        public int ReceiveLowWatermark
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.ReceiveLowWatermark);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.ReceiveLowWatermark, value);
            }
        }
        ...
        public int MulticastHops
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.MulticastHops);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.MulticastHops, value);
            }
        }
        ...
        public bool IPv4Only
        {
            get
            {
                return this.m_socket.GetSocketOptionX<bool>(ZmqSocketOption.IPv4Only);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.IPv4Only, value);
            }
        }
        ...
        public string LastEndpoint
        {
            get
            {
                return this.m_socket.GetSocketOptionX<string>(ZmqSocketOption.LastEndpoint);
            }
        }
        ...
        public bool RouterMandatory
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.RouterMandatory, value);
            }
        }
        ...
        public bool TcpKeepalive
        {
            get
            {
                return this.m_socket.GetSocketOption(ZmqSocketOption.TcpKeepalive) == 1;
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.TcpKeepalive, value ? 1 : 0);
            }
        ...
        public TimeSpan TcpKeepaliveIdle
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.TcpKeepaliveIdle);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.TcpKeepaliveIdle, value);
            }
            // TODO: What about the value -1, which means use the OS default?  jh
            // See  http://api.zeromq.org/3-2:zmq-getsockopt
        }
        ...
        /// <summary>
        ///     Get or set the TCP keep-alive interval - the duration between two keepalive transmission if no response was
        ...
        public TimeSpan TcpKeepaliveInterval
        {
            get
            {
                return this.m_socket.GetSocketOptionTimeSpan(ZmqSocketOption.TcpKeepaliveIntvl);
            }
            set
            {
                this.m_socket.SetSocketOptionTimeSpan(ZmqSocketOption.TcpKeepaliveIntvl, value);
            }
        }
        ...
        public bool DelayAttachOnConnect
        {
            get
            {
                return this.m_socket.GetSocketOptionX<bool>(ZmqSocketOption.DelayAttachOnConnect);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.DelayAttachOnConnect, value);
            }
        }
        ...
        public bool XPubVerbose
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.XpubVerbose, value);
            }
        }
        ...
        public bool XPubBroadcast
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.XPublisherBroadcast, value);
            }
        }
        ...
        public bool RouterRawSocket
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.RouterRawSocket, value);
            }
        }
        ...
        public bool RouterHandover
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.RouterHandover, value);
            }
        }
        ...
        public Endianness Endian
        {
            get
            {
                return this.m_socket.GetSocketOptionX<Endianness>(ZmqSocketOption.Endian);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.Endian, value);
            }
        }
        ...
        public bool ManualPublisher
        {
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.XPublisherManual, value);
            }
        }
        ...
        public bool DisableTimeWait
        {
            get
            {
                return this.m_socket.GetSocketOptionX<bool>(ZmqSocketOption.DisableTimeWait);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.DisableTimeWait, value);
            }
        }
        ...
        public int PgmMaxTransportServiceDataUnitLength
        {
            get
            {
                return this.m_socket.GetSocketOptionX<int>(ZmqSocketOption.PgmMaxTransportServiceDataUnitLength);
            }
            set
            {
                this.m_socket.SetSocketOption(ZmqSocketOption.PgmMaxTransportServiceDataUnitLength, value);
            }
        }
    }
}